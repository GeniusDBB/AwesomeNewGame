...
public class PlayerMovementStats : ScriptableObject
{
    ...
    public float InitialJumpVelocitty { get; private set; }
    public float AdjustedJumpHeight { get; private set; }

    //WallJump
    public float WallJumpGravity { get; private set; }
    public float InitialWallJumpVelocitty { get; private set; }
    ...
    private void CalculateValues()
    {
        ...
        InitialJumpVelocitty = Mathf.Abs(Gravity) * TimeTillJumpApex;
        ...
        InitialWallJumpVelocitty = Mathf.Abs(WallJumpGravity) * TimeTillJumpApex;
    }
}
